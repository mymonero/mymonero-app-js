...
const BackgroundStringCryptor = require(__dirname + "/../../symmetric_cryptor/BackgroundStringCryptor.electron")
...
function NewHydratedContext(app, menuController, urlOpeningController, appUpdatesController, monero_utils) {
	...
	context.string_cryptor__background = new BackgroundStringCryptor({}, context)
